...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    // OPTIONAL: Set the path of an additional "preload" script that can be used to
...
function getDevices() {
  ...
  bonjourClient.client.find({ type: 'googlecast' }, (service) => {
    ...
    if (mainWindow) {
      console.log('Notifying of device: ' + device.txt.fn);
      mainWindow.webContents.send(channels.GET_DEVICES, device);
    }
    else {
...
ipcMain.on(channels.FETCH_DEVICES, (event, arg) => {
